...
console.log(raw_location_name);
console.log(raw_location_address);

var raw_details = document.getElementsByClassName("_4n-j _3cht fsl")[0];
if (raw_details.innerText == undefined) {
	document.getElementsByClassName("see_more_link")[0].click();
	raw_details = document.getElementsByClassName("text_exposed_root text_exposed")[0].innerText;
} else {
	raw_details = raw_details.innerHTML;
}
